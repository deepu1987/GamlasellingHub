...
public class ProductListAdapterInStock extends RecyclerView.Adapter<ProductListAdapterInStock.ProductCategoryListViewHolder> {

    public Context context;
    View itemView;
    static onProductclicklistner mlistner;
    ArrayList<ProductlistBean> objArrayList;
    public ProductListAdapterInStock(Context context, ArrayList<ProductlistBean> objArrayList)
    {
    ...
    @Override
    public ProductListAdapterInStock.ProductCategoryListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.
                from(parent.getContext()).
                inflate(R.layout.product_row, parent, false);
        // itemView.setOnClickListener();

        return new ProductListAdapterInStock.ProductCategoryListViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ProductListAdapterInStock.ProductCategoryListViewHolder holder, int position) {
