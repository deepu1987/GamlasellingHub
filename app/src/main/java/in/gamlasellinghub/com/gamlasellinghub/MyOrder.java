...
public class MyOrder extends Fragment implements onCheckBoxClickListner{
    ...
    onCheckBoxClickListner mClicklistner;
    LinearLayoutManager llm;
    int limitstart =0;
   // int limitend = 15;
    int rowcount;
    String searchquery;
    LinearLayout llAddToBulk;
    ArrayList<String> objPositionArrayList = new ArrayList<>();
    public MyOrder()
    {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /* getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        recList = (RecyclerView) v.findViewById(R.id.orderlist);
        llAddToBulk = v.findViewById(R.id.addtoshipmentbulk);
        ...
        llAddToBulk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(objPositionArrayList.size()>0) {
                    String data = "";
                    for(String positions : objPositionArrayList)
                    {
                        data = data+","+positions;
                    }
                    Toast.makeText(getActivity(), "hellooo--->" + objPositionArrayList.size()+"-------------->"+data, Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(getActivity(), "Select at least one record", Toast.LENGTH_SHORT).show();
                }
            }
        });
        return v;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        limitstart = limitstart+Utility.LIMIT_INTERVAL;
                           ...
                           MyOrderAdapter ca = new MyOrderAdapter(objArrayList, getActivity());
    ...
    @Override
    public void onCheckBoxClick(ArrayList<String> position) {
        objPositionArrayList = position;
