...
public class Shipped extends Fragment implements onPlantsItemClickListner{
    ...
    public static Shipped newInstance(String param1, String param2) {
        Shipped fragment = new Shipped();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_shipped, container, false);
       ...
       /* getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        recList = (RecyclerView) v.findViewById(R.id.shippedorderlist);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.ORDER_LIST,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ShippedOrderAdapter ca = new ShippedOrderAdapter(objArrayList, getActivity());
