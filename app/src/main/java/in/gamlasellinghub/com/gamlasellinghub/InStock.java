 ...
 */
public class InStock extends Fragment implements onProductclicklistner{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.CATALOG_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ProductListAdapterInStock productListAdapter = new ProductListAdapterInStock(getActivity().getApplicationContext(), objArrayList);
