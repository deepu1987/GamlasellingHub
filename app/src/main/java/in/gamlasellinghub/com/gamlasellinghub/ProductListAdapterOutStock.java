...
public class ProductListAdapterOutStock extends RecyclerView.Adapter<ProductListAdapterOutStock.ProductCategoryListViewHolder> {

    public Context context;
    View itemView;
    static onProductclicklistner mlistner;
    ArrayList<ProductlistBean> objArrayList;
    public ProductListAdapterOutStock(Context context, ArrayList<ProductlistBean> objArrayList)
    {
    ...
    @Override
    public ProductListAdapterOutStock.ProductCategoryListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.
                from(parent.getContext()).
                inflate(R.layout.product_row, parent, false);
        // itemView.setOnClickListener();

        return new ProductListAdapterOutStock.ProductCategoryListViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ProductListAdapterOutStock.ProductCategoryListViewHolder holder, int position) {
        ...
        holder.txtfewleft.setText("Out Stock");
