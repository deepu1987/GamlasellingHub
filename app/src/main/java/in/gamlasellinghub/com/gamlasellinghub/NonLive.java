 ...
 */
public class NonLive extends Fragment implements onProductclicklistner{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.CATALOG_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ProductListAdapterNonLive productListAdapter = new ProductListAdapterNonLive(getActivity().getApplicationContext(), objArrayList);
