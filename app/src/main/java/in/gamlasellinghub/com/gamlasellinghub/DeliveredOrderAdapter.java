...
public class DeliveredOrderAdapter extends RecyclerView.Adapter<DeliveredOrderAdapter.DeliveredOrderViewHolder> {
    ...
    public DeliveredOrderAdapter(ArrayList<ProductlistBean> objArraylist, Context context)
    {
    ...
    @Override
    public DeliveredOrderViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.
                from(parent.getContext()).
                inflate(R.layout.order_shipped_list_row, parent, false);
        // itemView.setOnClickListener();

        return new DeliveredOrderViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(DeliveredOrderViewHolder holder, int position) {
    ...
    public static class DeliveredOrderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        private TextView txtPrice,txtname,txtorderid,txtdate,txtStatus,txtAdress;
        private CircleImageView ivImage;
        public DeliveredOrderViewHolder(View v) {
