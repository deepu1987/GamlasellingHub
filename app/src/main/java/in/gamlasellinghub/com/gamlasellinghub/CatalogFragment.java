...
public class CatalogFragment extends Fragment   {
    ...
    String [] statusarray = {"In Stock","Out Stock","Non Live"};
    int currentitem;
    int newcurrentitem;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        Bundle bundleInStock = new Bundle();
        bundleInStock.putString("Searchquery",searchquery);
        instock.setArguments(bundleInStock);


        OutStock ourstock =  new OutStock();
        Bundle bundleourstock = new Bundle();
        bundleourstock.putString("Searchquery",searchquery);
        ourstock.setArguments(bundleInStock);


        NonLive nonlive =  new NonLive();
        Bundle bundlenonlive = new Bundle();
        bundlenonlive.putString("Searchquery",searchquery);
        nonlive.setArguments(bundleInStock);

        adapter.addFragment(instock, "In Stock");
        adapter.addFragment(ourstock, "Out of stock");
        adapter.addFragment(nonlive, "Non Live");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.searchcatalog:
                ...
                Intent srachIntent = new Intent(getActivity(),SearchCatalog.class);
